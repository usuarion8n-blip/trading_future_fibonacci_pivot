...
async function finalizeReservedTradeInDb({
    ...
    try {
        ...
        const resTrade = await fetchWithTimeout(`${API_TRADES_URL}${TRADE_API_PATH}/${id}`);
        let currentMeta = {};
        if (resTrade.ok) {
    ...
    for (const [id, t] of openTrades.entries()) {
        try {
            ...
            if (DRY_RUN) {
                ...
                // =========================
                // B) Intento normal vía algoOrder
                // =========================
                try {
                ...
                // =========================
                // C) Fallback por posición real en Binance
                // =========================
                if (!triggeredOrderId) {
            ...
            // =========================
            // D) Cancelar algo opuesto solo si fue cierre normal TP/SL
            // =========================
            if (!DRY_RUN) {
